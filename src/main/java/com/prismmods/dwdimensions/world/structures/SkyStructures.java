...
/*
https://github.com/TelepathicGrunt/StructureTutorialMod/blob/1.19.0-Forge-Jigsaw/src/main/java/com/telepathicgrunt/structuretutorial/structures/SkyStructures.java
 */
...
public class SkyStructures extends Structure {
    ...
    public StructureType<?> type() {
        return DWDStructures.SKY_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
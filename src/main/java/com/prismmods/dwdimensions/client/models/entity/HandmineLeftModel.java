...
public class HandmineLeftModel extends EntityModel<HandmineEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r4 = bone.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(14, 17).addBox(-3.9109F, -2.2993F, -0.9426F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.2996F, 3.8377F, 0.0F, 0.0F, 0.0F, -0.4363F));

        PartDefinition cube_r5 = bone.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(25, 18).addBox(2.5805F, -3.7436F, -0.116F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.9167F, 0.4167F, 0.0F, 0.5236F, 0.0644F, 0.2312F));

        PartDefinition cube_r6 = bone.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(30, 18).addBox(-4.7255F, -6.3298F, 1.72F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.7833F, 4.6667F, -1.5F, 0.2618F, 0.0F, -0.4363F));

        PartDefinition cube_r7 = bone.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(40, 18).addBox(-3.5116F, -4.2813F, -0.0202F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.3833F, 0.4167F, 0.0F, 0.6981F, 0.0436F, -0.2182F));

        PartDefinition cube_r8 = bone.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(35, 18).addBox(-1.7149F, -4.7696F, -0.543F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2833F, 0.4167F, 0.0F, 0.6109F, 0.0113F, -0.0015F));

        PartDefinition cube_r9 = bone.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(30, 18).addBox(0.478F, -4.4724F, -0.5332F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.8167F, 0.4167F, 0.0F, 0.6109F, -0.0113F, 0.0451F));

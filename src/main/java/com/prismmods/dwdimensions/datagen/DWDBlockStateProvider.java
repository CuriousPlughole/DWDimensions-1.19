...
public class DWDBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        //simpleBlock(DWDBlocks.POTTED_SKARO_PETRIFIED_FLOWER_1.get(), flowerPotCross(ForgeRegistries.BLOCKS.getKey(DWDBlocks.POTTED_SKARO_PETRIFIED_FLOWER_1.get()).getPath()));
        //simpleBlock(DWDBlocks.POTTED_SKARO_PETRIFIED_FLOWER_2.get(), flowerPotCross(ForgeRegistries.BLOCKS.getKey(DWDBlocks.POTTED_SKARO_PETRIFIED_FLOWER_2.get()).getPath()));
        //simpleBlock(DWDBlocks.POTTED_SKARO_PETRIFIED_FUNGUS.get(), flowerPotCross(ForgeRegistries.BLOCKS.getKey(DWDBlocks.POTTED_SKARO_PETRIFIED_FUNGUS.get()).getPath()));
